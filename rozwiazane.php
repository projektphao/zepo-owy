...
if(isset($_SESSION['login'])) {
    ...
    if($rang1['user_rang'] == 1) {
        $zap="SELECT zadania.tytul, zadania.grupa, rozwiazania.login, rozwiazania.rozw, rozwiazania.ID FROM zadania LEFT JOIN rozwiazania ON zadania.ID=rozwiazania.ID_zad where rozwiazania.ocena=''";
...
<br>
<a href="archiwum.php">Sprawdzone</a>
<table width="800" border="0" cellspacing="1" cellpadding="0">
<tr>
<td><form id="zad" action="sprawdz.php?source=rozwiazane.php" method="post" onsubmit="return zad()">
